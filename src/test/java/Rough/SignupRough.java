...
public class SignupRough extends AppBase {
	...
	public void signup() {
		...
		for (int i = 0; i <= 30; i++) {
			...
			values("Email_XPATH", "lisn0" + i + "@berijam.com");
			...
			Object FirmId = ((JavascriptExecutor) driver).executeScript("return userData.firmId;");
			System.out.println("Firm Id - "+FirmId);

			Object emailId = ((JavascriptExecutor) driver).executeScript("return userData.emailId;");
			System.out.println("emailId - " + emailId);

			click("Expand_XPATH");
			click("Manage_Account_XPATH");
			wait.until(ExpectedConditions
					.invisibilityOfElementLocated(By.xpath(variables.getProperty("ProgressBar_XPATH"))));
			click("Upgrade_XPATH");
