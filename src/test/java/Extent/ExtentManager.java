...
public class ExtentManager {
	...
	public static String fileName;
	    ...
	    public static ExtentReports createInstance(String fileName) {
	        ...
	        extent.setSystemInfo("Organization", "Apptivo");
	        extent.setSystemInfo("Build no", "App-01");
		...
		File screeshot = ((TakesScreenshot)  AppBase.driver).getScreenshotAs(OutputType.FILE);
